...
function drawSmallSquares() {
  ...
  // Add random colored squares along the horizontal lines to mimic Mondrian painting
  for (let horizontal of horizontalLines) {
  ...
  // Add random colored squares along the vertical lines
  for (let vertical of verticalLines) {
